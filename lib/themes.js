 ...
 * Restores both dark mode and color theme to prevent any flash on load.
 */
...
(function(){
  try {
    ...
    // Dark mode — read universal key, fall back to system preference
    var dark = localStorage.getItem('darkMode');
    var isDark = dark ? dark === 'dark' : window.matchMedia('(prefers-color-scheme: dark)').matches;
