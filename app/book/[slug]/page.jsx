  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50/20 to-indigo-50/30">
      ...
      <footer className="text-center py-10">
        <a href="https://cliniwayz.com" target="_blank" rel="noreferrer"
          className="inline-flex items-center gap-2 bg-white border border-gray-200 hover:border-blue-200 hover:shadow-sm rounded-full px-4 py-2 transition-all group">
          ...
          <span className="text-xs text-gray-500 group-hover:text-blue-600 transition-colors">
            Powered by <strong className="font-semibold">Cliniwayz</strong>
          </span>
