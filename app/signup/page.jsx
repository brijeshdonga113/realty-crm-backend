  ...
  return (
    <div>
      <label className="form-label">
        {label}
        {optional && <span className="text-gray-400 dark:text-gray-500 font-normal ml-1">(optional)</span>}
      </label>
      {children || (
        <input
          type={type}
    ...
    <div className="auth-theme min-h-screen flex">
      ...
      <div className="w-full lg:w-1/2 min-h-screen flex items-start justify-center p-8 bg-white dark:bg-gray-900 overflow-y-auto">
        <div className="w-full max-w-lg py-8">
          ...
          <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-1">Create your doctor account</h2>
          <p className="text-gray-500 dark:text-gray-400 text-sm mb-8">Fill in your details to get started — it's free.</p>
