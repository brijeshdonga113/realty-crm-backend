...
export default function EditPatientPage() {
  ...
  const setSpecialtyField   = (key, value) => setFormState(p => ({ ...p, specialtyData: { ...p.specialtyData, [key]: value } }))
  ...
  return (
    <AppLayout title="Edit Patient" action={<ActionBar/>}>
      <div className="max-w-5xl mx-auto pb-12 space-y-5">
        ...
        {/* ── Patient Profile ───────────────────────────────────────────── */}
        <SectionCard accentColor="teal" title="Patient Profile" defaultOpen={true}
          ...
          <div>
            ...
            <AutoTextarea value={form.address} onChange={e => set('address', e.target.value)}
              placeholder="Full address including city, state, zip" className="input-field resize-y"/>
          </div>
